...
<section style="padding: 80px 0; background: linear-gradient(135deg, #0a1628 0%, #1e3a5f 100%); text-align: center;">
    <div style="max-width: 600px; margin: 0 auto; padding: 0 20px;">
        <h2 style="font-family: var(--font-display); font-size: 2rem; color: white; margin-bottom: 16px;">Llevamos la satisfacción de tus pasajeros al siguiente nivel</h2>
        <p style="color: rgba(255,255,255,0.8); margin-bottom: 30px;">Somos tu mayorista de confianza. Contáctanos.</p>
